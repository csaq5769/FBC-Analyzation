...
// A5
/**
 * This function checks if access token is found in cookie and returns resulting threat description
 *
 * @brief ThreatsImplicitGrant::accessTokenInCookie
 * @param str_website
 * @return str_threat
 */
QString ThreatsImplicitGrant::accessTokenInCookie(QString str_website)
{
    QString str_threat;

    if(g_sqlHandlerInstance.checkSetTokenCookie(str_website))
    {
